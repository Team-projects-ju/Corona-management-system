...
<section style="height: 80vh; height: 80vh;
  ...
  .then((data) => {
    console.log(data);
    var size = data.numFound;
    var str = "<table><thead><td>Hospital Name</td><td>Beds available</td></thead>";
    ...
    {
      str+="<tr><td>"+data.result[i].name+"</td><td>"+Math.floor((Math.random() * 100) + 1)+"</td></tr>";
    }
    str+="</table>";
